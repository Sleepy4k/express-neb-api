...
const appServiceProvider = (_req: Request, res: Response, next: NextFunction): void => {
  ...
  res.locals.description =
    "Nach Exam Bypasser (NEB): Effortlessly bypass online exam restrictions and get quick, reliable answers for your assignments. Free to use with a redeem code. Safe & private.";
