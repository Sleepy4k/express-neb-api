  ...
  var pe = "tooltip",
    ...
    Ue = (function () {
      ...
      return (
        ...
        (t._getConfig = function (t) {
          return (
            "number" == typeof (t = l({}, this.constructor.Default, g(this.element).data(), "object" == typeof t && t ? t : {})).delay &&
        ...
        (t._fixTransition = function () {
          ...
          null === t.getAttribute("x-placement") &&
            (g(t).removeClass(Ne), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
        }),
        (i._jQueryInterface = function (n) {
          return this.each(function () {
    ...
    Hn = (function () {
      ...
      return (
        (t.show = function () {
          ...
          if (
            !(
              (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && g(this._element).hasClass(bn)) ||
  ...
  var Rn = "toast",
    ...
    Xn = (function () {
      ...
      return (
        ...
        (t._getConfig = function (t) {
          return (
            (t = l({}, Vn, g(this._element).data(), "object" == typeof t && t ? t : {})), _.typeCheckConfig(Rn, t, this.constructor.DefaultType), t
          );
        }),
        (t._setListeners = function () {
          var t = this;
